...
func (r *resourceR) GetProperty() *Property {
	if r == nil {
		return nil
	}
	return r.Property
...
func (o *Resource) Property(mods ...qm.QueryMod) propertyQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`resource_id` = ?", o.ID),
	}
...
func (resourceL) LoadProperty(ctx context.Context, e boil.ContextExecutor, singular bool, maybeResource interface{}, mods queries.Applicator) error {
	var slice []*Resource
	var object *Resource
	...
	query := NewQuery(
		qm.From(`properties`),
		qm.WhereIn(`properties.resource_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetProperty of the resource to the related item.
// Sets o.R.Property to related.
// Adds o to related.R.Resource.
func (o *Resource) SetProperty(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Property) error {
	var err error

	if insert {
		queries.Assign(&related.ResourceID, o.ID)
